# Django settings for benassi project.

# Setup for the project path
import os
...
ADMINS = (
    ('Alfred Chiesa', 'alfred@villaroad.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'benassi.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'xet-)fuuo-sw%3%cj8!^4ym!vod!(&amp;rh0j2xckbs49l05dqfi*'
...
ROOT_URLCONF = 'benassi.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'benassi.wsgi.application'
